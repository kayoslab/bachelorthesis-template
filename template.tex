...
\major{Bachelor of Science (B.Sc)}  % Studiengang inkl. Abkürzung
\subject{Wirtschaftsinformatik} % Studienfach
\faculty{Wirtschaft und Gesundheit} % Fachbereich

\period{Sommersemester 2016}
\firstexaminer{Titel Vorname Name} 		  % Erstprüfer/in
\secondexaminer{Titel Vorname Name}   % Zweitprüfer/in
\address{G\"{u}tersloh,} 			 % Im Zusammenhang mit dem Datum wird hinter dem Ort ein Komma angegeben
